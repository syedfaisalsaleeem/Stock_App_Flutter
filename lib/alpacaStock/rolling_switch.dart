...
class _RollingSwitchState extends State<LiteRollingSwitch>
              ...
              child: Transform.rotate(
                ...
                child: Container(
                  ...
                  decoration: ShapeDecoration(
                    color: Colors.white,
                    shape: CircleBorder(
                      side: BorderSide(width: 14.0, style: BorderStyle.solid,color: Colors.white),
  ...
  _determine({bool changeState = false}) {
    setState(() {
      ...
      if(turnState==false){
        widget.funcOn();
        // widget.showCash = widget.cash;
        // print(widget.showCash);
      }
      else{
        widget.funcOff();
        // widget.showCash = widget.buyingPower;
        // print(widget.showCash);
      }
    });
  }
